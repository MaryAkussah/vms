        ...
        <section class="section">
          <div class="row">
              <div class="col-12 col-md-6 col-lg-8">
                  <div class="card">
                    <div class="card-header">Staff Report</div>
                    <div class="card-body">
                    <form action="getStaffReport.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4 col-lg-6">
                                                    <select class="form-control select2" name="status_id" placeholder="Select Status">
                                                        <option value="" selected disabled>--SELECT STATUS</option>
                                                            <?php

                                                                $result = mysqli_query($conn,"SELECT * FROM status LIMIT 7");
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4 col-lg-6">
                                                    <select class="form-control select2" name="department_id" placeholder="Select Department">

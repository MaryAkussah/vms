												...
												<div class="row">
													...
													<div class="col-lg-9">
														<div class="row">
															<div class="col-md-6">
																<div class="input-block mb-3">
																	<input type="text" placeholder="First Name" value="<?= $depHeadData['first_name']?>" class="form-control" required>
																</div>
															</div>
															<div class="col-md-6">
																<div class="input-block mb-3">
																	<input type="text" placeholder="Last Name" value="<?= $depHeadData['last_name']?>"  class="form-control" required>
...
<script>
    ...
    if (staff_id == "" || supervisor_id == "" || start_date == "" || end_date == "" || leave_reason == "") {

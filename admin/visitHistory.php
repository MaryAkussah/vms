                ...
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-striped" id="table-1">
                     ...
                     WHERE check_in.team_id IS NULL OR check_in.visitor_id = team_lead.lead_visitor_id
                            ...
                            <td>
                                <?php 
                                    ...
                                    if (!empty($fetch['team_id'])) {
                                        echo " <a href='javascript:void(0);'  class='team-toggler' data-team-id='{$fetch['team_id']}'><i class='fas fa-plus-circle text-success'></i></a>";
                                    }
                                ?>
                            </td>
=======

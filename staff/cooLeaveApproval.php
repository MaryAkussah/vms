            ...
            <section class="section">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-header"><strong>COO Leave Approval</strong></div>
                            <div class="card-body">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button class="btn btn-sm btn-danger" data-toggle="modal" data-backdrop="false" data-target="#declineLeave<?= $fetch['leave_id'] ?>"><i class="fas fa-trash"></i></button>
                                                    </td>
                                                </tr>
                                                <!-- Include your modal files here -->
                                                <!-- Example: -->
                                                <?php include 'modals/cooLeaveModal.php' ?>
                                            <?php 
                                                }
                                            } else {

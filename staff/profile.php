              ...
              <div class="col-12 col-md-12 col-lg-4">
                <div class="card author-box">
                  <div class="card-body">
                    ...
                    <img src="<?php if(empty($profile_photo)){echo "../assets/img/users/user-2.png";}else{echo preg_replace('/^\.\.\//', '',$profile_photo);} ?>" alt="profile photo" width="auto" height="250px" id="profile-photo">
                      <div class="clearfix"></div>
                      <div class="author-box-name">
                        <a href="#"><?= $first_name ." ".$last_name?></a>
                      </div>
                      <div class="author-box-job"><?= $staff_role_name?></div>
                    </div>
                    <div class="text-center">
                      <div class="author-box-description">
                        <p>
                          Of course we're Waltergates, we think , create and design
                        </p>
                      </div>
                  ...
                  <div class="card-body">                    
                    ...
                    <div class="row">
                        <div class="form-group col-md-6 col-12">
                            ...
                            <input type="tel" class="form-control" name="staff_phone" value="<?php echo $staff_phone; ?>" required>
                            <div class="invalid-feedback">Please fill in the phone number</div>
                        </div>
                        <div class="form-group col-md-6 col-12">
                            <label>Email</label>
                            <input type="user_email" class="form-control" name="staff_email" value="<?php echo $staff_email; ?>" required>

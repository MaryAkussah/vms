<?php 
    ...
    if (isset($_POST['generateReport'])) {
        ...
        LEFT JOIN visitors ON visitors.visitor_id=check_in.visitor_id
                    ...
                    AND check_in.staff_id='$staff_id'";
                ...
                <div class="col-12 col-md-8 col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="">Visitors Report (<?php echo $startDate ?> : <?php echo $endDate ?>)</h4>
                                </div>
                                <div class="card-body">                            
                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <?php $i=1; foreach ($staffVisitor as $fetch):
                                        ...
                                        <tr>
                                            ...
                                            <td><?php if(empty($fetch['time_out'])){echo "<b class='text-danger'>Not Set</b>";}else{echo date('g:i A', strtotime($fetch['time_out']));}?></td>
